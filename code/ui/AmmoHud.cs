...
class AmmoHud : Panel
{
	...
	public Label clip1Size;
	public Label clip2Size;
	...
	public AmmoHud()
	{
		...
		clip1Size = Add.Label( "/0", "clipsize two" );
		clip2Size = Add.Label( "/0", "clipsize two" );
	...
	public override void Tick()
	{
		...
		if(ActiveWeapon is null){
			...
			clip1Size.SetClass("hidden", true);
			clip2Size.SetClass("hidden", true);
